...
{
	prescaler_ms =  SystemCoreClock / 1000-1; //Значения предделителя для формирование милисекундной задержки.
	prescaler_us =  SystemCoreClock / 1000000-1;//Значения предделителя для формирование микросекндной задержки.
